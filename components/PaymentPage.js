...
/>
            ...
            <div className='cover w-full bg-red-50 relative'>
                ...
                <div className='absolute overflow-hidden -bottom-20 md:right-[44%] right-[33%] border-2 border-white rounded-full size-36'>
                    <img className='rounded-full object-cover size-36' width={128} height={128} src={currentUser.profilepic} alt="" />
                </div>
            </div>

            <div className="info flex flex-col justify-center items-center my-24 gap-2 mb-32">
